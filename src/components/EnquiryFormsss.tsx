...
const EnquiryForm: React.FC = () => {
  ...
  return (
    ...
    //       <Toaster />
    //     </div>
    <div className="h-[80vh] w-full max-w-2xl mx-auto sm:dark p-4 lg:p-8  bg-opacity-90">
      {!isOtpWindowOpen && (
                ...
                <TabsContent value="interior">
                  ...
                  <div className="space-y-4">
                    <div>
                      <label>Type of Interior Work</label>
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-2">
                        {/* Map through interiorTypes and render checkboxes */}
                      </div>
                    </div>
                  </div>
                </TabsContent>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      value={formData.ration}
                      onChange={(e) =>
                        setFormData({ ...formData, ration: e.target.value })
                      }
                      required
                    />
                  </div>
